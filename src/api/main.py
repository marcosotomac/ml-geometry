...
async def startup_event():
    ...
    try:
        if os.path.exists(model_path):
            predictor = ShapePredictor(model_path, config_path if os.path.exists(config_path) else None)
...
async def predict_image(
    ...
    try:
        ...
        return PredictionResponse(
            ...
            probabilities=result.get('probabilities') if return_probabilities else None
        )
