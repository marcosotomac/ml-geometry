...
class CustomCallback(keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        print(f"  Learning Rate: {keras.backend.get_value(self.model.optimizer.lr):.6f}")
        print(f"{'='*60}\n")
...
class TrainingPipeline:
    ...
    def create_callbacks(self, model_name: str, patience: int = 15) -> list:
        ...
        callbacks = [
            ...
            # CSV Logger
            CSVLogger(
                filename=os.path.join(self.log_dir, f'{run_name}_training.csv'),
                separator=',',
                append=False
            ),
    ...
    def train(self, 
        ...
        # Save final model
        final_model_path = os.path.join(self.output_dir, f'{model_name}_final.h5')
        ...
        config_path = os.path.join(self.output_dir, f'{model_name}_config.json')
